onRecordCreateRequest(
  (e) => {
    ...
    var hash = $security.sha256(protocol + opUuid + record.id + colName)
    ...
    try {
      ...
      log.set('record_uuid', record.getString('uuid') || '')
      log.set('record_friendly_code', record.getString('friendly_code') || '')
      log.set('operation_type', 'Create')
