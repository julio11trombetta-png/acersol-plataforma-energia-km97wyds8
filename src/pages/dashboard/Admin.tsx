...
import { fetchDashboardCharts, type DashboardChartData } from '@/lib/dashboard-data'
...
export default function AdminDashboard() {
  ...
  const [chartData, setChartData] = useState<DashboardChartData>(EMPTY_CHARTS)

  const loadData = async () => {
    try {
      const [clientsRes, plantsRes, invoicesRes, leads, cashFlow, ticks, acts, charts] =
        await Promise.all([
          getClients(1, ''),
          getPlants(1, ''),
          getInvoices(),
